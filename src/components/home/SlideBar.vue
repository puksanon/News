      ...
      <header id="masthead" role="banner">
        <div class="container">
          <button class="hamburger hamburger--boring" type="button">
            ...
            <span class="hamburger-label">Online Thesis Collection System</span>
          </button>
        <form id="masthead-search">
        <input type="search" name="Search" aria-labelledby="search-label" placeholder="Search" class="draw">
          ...
          <nav id="site-nav" role="navigation">
            ...
            <div class="col">
              <h4>For Staff</h4>
              <ul>
                <li><a><router-link to="/signin">Sign in</router-link></a></li>
            ...
            <div class="col">
              <h4>For Student</h4>
              <ul>
                <li><a><router-link to="/student_signin">Sign in</router-link></a></li>
                <!-- <li><a href="#">Client Partners</a></li> -->
              </ul> 
            </div>
            <div class="col">
...
#masthead-search input {
  ...
  -webkit-appearance: none;
  box-shadow: 0px 0px 11px 7px rgba(0, 0, 0, 0.17)
}
