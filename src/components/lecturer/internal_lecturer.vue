					...
					<div class="section">
						<div class="container">
                            <div class="header_title">
                                <div class="card">
                                    <h3>Internal Lecturer</h3>
                                </div>
                            </div>
                            <div class="btn_manu">
                                <div class="btn_class_card">
                                    <a><router-link class="btn btn-primary" to="/home/internal_lecturer/insert_internal_lecturer">+ Insert</router-link></a>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr 
                                            ...
                                            <td>
                                                <a  class="btn_choises btn btn-dark" :href="`/home/internal_lecturer/edit/${row.lecturer_id}`">EDIT</a>
    ...
    async created() {
        try{
            const res = await this.axios.request({
                method: 'get',
                url: 'http://localhost:5000/lecturer/list/internal',
                headers: authHeader()
            }).then(res =>{
    ...
    methods: {
        ...
        Delete_lecturer: async function(id) {
            try{
                const res = await this.axios.request({
                method: 'delete',
                url: `http://localhost:5000/lecturer/internal/${id}`,
                headers: authHeader()
                }).then(res =>{
